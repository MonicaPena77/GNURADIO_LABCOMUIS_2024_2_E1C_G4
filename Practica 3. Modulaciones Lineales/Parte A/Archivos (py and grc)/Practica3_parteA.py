...
class Practica3_parteA(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Practica3_parteA")
        ...
        self._ka_range = qtgui.Range(-2, 2, 10e-3, 2, 200)
...
def main(top_block_cls=Practica3_parteA, options=None):
