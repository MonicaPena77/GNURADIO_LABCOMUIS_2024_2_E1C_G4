...
class Practica3_ParteB_Punto2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Practica3_ParteB_Punto2")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcomu/Escritorio/Practica_3/Parte b/despecha_rosalia.wav', True)
...
def main(top_block_cls=Practica3_ParteB_Punto2, options=None):
