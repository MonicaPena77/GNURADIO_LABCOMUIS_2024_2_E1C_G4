...
class Practica2_parteB(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PracticaB1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PracticaB1")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Practica2_parteB")
        ...
        self.blocks_throttle2_0.set_block_alias("blocks_throttle2_0")
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_float_to_complex_0.set_block_alias("blocks_float_to_complex_0")
...
def main(top_block_cls=Practica2_parteB, options=None):
