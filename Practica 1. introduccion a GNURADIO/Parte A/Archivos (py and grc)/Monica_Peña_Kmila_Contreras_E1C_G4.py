...
class Monica_Peña_Kmila_Contreras_E1C_G4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Flujo Grama", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Flujo Grama")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Monica_Peña_Kmila_Contreras_E1C_G4")
...
def main(top_block_cls=Monica_Peña_Kmila_Contreras_E1C_G4, options=None):
