...
# Generated: Thu Aug 29 17:00:49 2024
##################################################
...
class Lab_comu_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Primer Flujograma")
        ...
        # Blocks
        ##################################################
        self._frequency_range = Range(-4500, 4500, 100, 0, 200)
        ...
        self.qtgui_time_sink_x_0.set_y_axis(0, 3)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, frequency, 3, 0)
        self._A_range = Range(0, 3, 100, 0, 200)
